                      ...
                      uint32_t srcClock_Hz)
{
    ...
    for (i = 0; i < numOfChnls; i++)
    {
        ...
        if (chnlParams->dutyCyclePercent > 10000U)
        {
            return kStatus_OutOfRange;
        }
        ...
        {
            cnv = (mod * chnlParams->dutyCyclePercent) / 10000U;
        }
        ...
        else
        {
            ...
            else
            {
                ...
                if ((chnlParams->firstEdgeDelayPercent + chnlParams->dutyCyclePercent) > 10000U)
                {
                    return kStatus_OutOfRange;
                }
                                ...
                                uint16_t dutyCyclePercent)
{
    ...
    {
        cnv = (mod * dutyCyclePercent) / 10000U;
    }
