...
#define LQR_SCHEDULE_THETA 0.25f    /* |theta_e| at which full turn gains engage [rad] */
...
/** Set/get the gain vector used when |theta_e| ≈ 0 (straight driving). */
...
/** Set/get the gain vector used when |theta_e| ≥ LQR_SCHEDULE_THETA (cornering). */
